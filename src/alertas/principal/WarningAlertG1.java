...
public class WarningAlertG1 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public WarningAlertG1(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertG1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertG1 dialog = new WarningAlertG1(new javax.swing.JFrame(), true);
